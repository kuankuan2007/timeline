...
const activitys: Activity[] = [
  {
    name: '幻兽聚',
    title: '趣夏唯渝',
    dateStart: new Date('2024-07-12'),
    dateEnd: new Date('2024-07-14'),
    city: '重庆',
    address: '万垚酒店',
  },
  {
